...
export default class AddKey extends Command {
  ...
  static flags = {
    ...
    name: flags.string({required: true, char: 'n', description: 'the key name (e.g. mobileDevice)'}),
  }

  static args = [{name: 'publicKey', description: 'A public key in base-58 encoding'}]
