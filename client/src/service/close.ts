...
import {arrayOf, didToPublicKey, ExtendedCluster, isKeypair, pubkeyOf} from "../lib/util";
 ...
 * @param signCallback
 */
export const close = async (ownerDID: string, payer: Keypair | PublicKey, signer?: Keypair, receiver?: PublicKey, signCallback?: SignCallback, cluster?: ExtendedCluster): Promise<void> => {
  ...
  await SolariumTransaction.closeInbox(inbox, ownerDIDKey, ownerPubkey, receiverPubkey, createSignedTx, cluster);
};
